LEGACY ALERT
======
This library is no longer supported, since it has become part of the [MineOS Screen API](https://github.com/IgorTimofeev/MineOS/wiki/Screen-API). Potential bugs will not be fixed
